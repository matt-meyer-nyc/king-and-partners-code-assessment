      ...
      <div className="accordion-container">
        <div className="accordion-col-one">
          ...
          <div className="accordion-holder">
            <div class="accordion-heading" onClick={handleOnClickDiningOpen}>
              <span>Dining</span>
              <div>
                <svg
                  width="16"
            ...
            <div class="accordion-heading" onClick={handleOnClickPlayOpen}>
            ...
            <div class="accordion-heading" onClick={handleOnClickPhotoOpen}>
